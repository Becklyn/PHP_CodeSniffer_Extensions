...
class Becklyn_Sniffs_Namespaces_UseDeclarationSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($diff !== 2) {
            ...
            $error = 'There must be 2 blank lines after the last USE statement; %s found;';
            $data  = array($diff);
